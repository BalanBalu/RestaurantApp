...
export function getKiloMeterCalculation(gpsLocation, restaurantLocation) {

  if (!!gpsLocation && !!restaurantLocation) {
    let result = getDistanceFromLatLonInKm(gpsLocation[0], gpsLocation[1], restaurantLocation[0], restaurantLocation[1])

    return result.toFixed(5) + ' Km'
